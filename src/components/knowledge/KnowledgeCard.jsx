...
const statusConfig = {
    Active: { label: 'Hoạt động', color: 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-400' },
    Draft: { label: 'Bản nháp', color: 'bg-yellow-50 text-yellow-700 dark:bg-yellow-500/10 dark:text-yellow-400' },
    Archived: { label: 'Lưu trữ', color: 'bg-gray-100 text-gray-600 dark:bg-gray-500/10 dark:text-gray-400' },
};
...
export default function KnowledgeCard({ entry, onEdit, onDelete, onView }) {
    const st = statusConfig[entry.status] || statusConfig.Active;
