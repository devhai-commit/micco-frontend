...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex bg-[#2a5298] relative overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative z-10 flex-col justify-center px-16 xl:px-24">
                <div className="auth-panel-left">
                    ...
                    <p className="text-white/60 text-sm leading-relaxed max-w-md">
                        Create your free account and unlock the full power of AI-driven
                        document management. Smart search, instant insights, and enterprise-grade security await.
                    </p>
                </div>

                {/* Feature highlights */}
                <div className="flex flex-col gap-3 mt-12 auth-panel-left" style={{ animationDelay: '0.2s' }}>
                    {[
                        { icon: '🔒', text: '256-bit AES encryption' },
                        { icon: '🤖', text: 'AI-powered document search' },
                        { icon: '👥', text: 'Team collaboration tools' },
                    ].map((item) => (
                        <div key={item.text} className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
            ...
            {/* ─── Right Panel (Form) ─── */}
            <div className="w-full lg:w-1/2 flex items-center justify-center relative z-10 px-6 py-8">
                <div className="w-full max-w-md auth-panel-right">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl shadow-black/20 p-8 sm:p-10 relative overflow-hidden">
                        ...
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-40 h-1 rounded-b-full bg-gradient-to-r from-accent-500 via-secondary-500 to-primary-600" />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            {/* Confirm Password */}
                            <div className="relative group">
                                <div className={`absolute left-4 top-1/2 -translate-y-1/2 w-9 h-9 rounded-xl flex items-center justify-center transition-colors ${!passwordsMatch
                                    ? 'bg-red-100 dark:bg-red-900/30'
                                    : 'bg-gray-100 dark:bg-gray-800 group-focus-within:bg-primary-600/10 dark:group-focus-within:bg-primary-600/20'
                                    }`}>
                                    <ShieldCheck className={`w-4 h-4 transition-colors ${!passwordsMatch
                                        ? 'text-red-500'
                                        : 'text-gray-400 group-focus-within:text-primary-600 dark:group-focus-within:text-primary-400'
                                        }`} />
                                </div>
                                <input
                                    type="password"
                                    ...
                                    className={`w-full pl-16 pr-5 py-3.5 rounded-2xl border bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:ring-2 transition-all text-sm ${!passwordsMatch
                                        ? 'border-red-400 focus:border-red-500 focus:ring-red-500/10'
                                        : 'border-gray-200 dark:border-gray-700 focus:border-primary-600 focus:ring-primary-600/10 dark:focus:border-secondary-400 dark:focus:ring-secondary-400/10'
                                        }`}
                                    required
                                />
                                {!passwordsMatch && (
                                    <p className="text-xs text-red-500 mt-1.5 ml-1 font-medium animate-fade-in">Passwords do not match</p>
                                )}
                            </div>
                            ...
                            <div className="flex items-start gap-2 pt-1">
                                <div
                                    ...
                                    className={`w-5 h-5 mt-0.5 rounded-md border-2 flex items-center justify-center transition-all cursor-pointer flex-shrink-0 ${agreeTerms
                                ...
                                <span className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                                    I agree to the{' '}
                                    <a href="#" className="text-primary-600 dark:text-secondary-400 hover:underline font-medium">Terms of Service</a>
                                    {' '}and{' '}
                                    <a href="#" className="text-primary-600 dark:text-secondary-400 hover:underline font-medium">Privacy Policy</a>
                                </span>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full py-4 rounded-2xl font-bold text-white text-sm tracking-wide transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
                                style={{
                            ...
                            <button
                                type="button"
                                className="w-full py-3.5 rounded-2xl font-semibold text-sm text-gray-700 dark:text-gray-300 border-2 border-gray-200 dark:border-gray-700 hover:border-primary-600 dark:hover:border-secondary-400 hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-3 group"
                            >
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <Link to="/login" className="font-bold text-primary-600 dark:text-secondary-400 hover:underline">
                                    Sign In
                                </Link>
                            </p>
                        </div>
                    ...
                    <div className="lg:hidden text-center mt-8">
                        <p className="text-white/50 text-xs">
                            © 2026 Micco AI. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
