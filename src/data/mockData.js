...
export const storageByType = [
    ...
    { type: 'Other', size: 4.3, fill: '#6B7280' },
];
...
export const testimonials = [
    {
        ...
        quote: 'DocVault AI transformed how we manage compliance documents. The AI chatbot finds answers in seconds that used to take hours of manual searching.',
        rating: 5,
    },
    {
        name: 'David Kim',
        ...
        quote: 'The smart search feature is incredible. Our legal team can now instantly cross-reference contracts and find relevant clauses across thousands of documents.',
        rating: 5,
    },
    {
        name: 'Rachel Torres',
        ...
        quote: 'We evaluated 12 document management platforms. DocVault AI was the clear winner — enterprise security with the simplicity our team actually uses.',
        rating: 5,
    },
];
...
export const examplePrompts = [
    ...
    'List key risks mentioned in the report.',
